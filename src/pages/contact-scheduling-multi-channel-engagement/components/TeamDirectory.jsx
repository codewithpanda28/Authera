  ...
  const teamMembers = [
    {
      ...
      expertise: ['machine-learning', 'strategy'],
      location: 'Bangalore',
      experience: '12+ years',
      email: 'rajesh.kumar@aiautomationhub.com',
      phone: '+91 98765 43210',
      linkedin: 'https://linkedin.com/in/rajeshkumar',
      avatar: 'https://randomuser.me/api/portraits/men/32.jpg',
      bio: 'Leading AI innovation with expertise in machine learning and strategic technology implementation for enterprise clients.',
      specialties: ['AI Strategy', 'Machine Learning', 'Team Leadership', 'Enterprise Solutions'],
      languages: ['English', 'Hindi', 'Kannada'],
      availability: 'Available for strategic consultations',
      certifications: ['AWS ML Specialty', 'Google Cloud AI', 'Microsoft AI Engineer']
    },
    {
      id: 2,
      name: 'Priya Sharma',
